  ...
  const menuLinks = [
    ...
    { 
      ...
      subItems: [
        ...
        { name: "Studio Web", href: "/services/web" },
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 w-full px-6 py-5 pointer-events-none">
        {/* Added 'relative' here to act as the anchor for the absolute menu */}
        <div className="max-w-7xl mx-auto flex items-center justify-between relative">
          ...
          {/* Moved AnimatePresence INSIDE the relative container */}
          <AnimatePresence>
            {open && (
              <motion.div
                initial="hidden"
                ...
                style={{
                  ...
                  top: -6,              // Adjusted top to align slightly over the button area
                  right: 0,             // Aligns flush with the container right edge
                  zIndex: 60,
                  minWidth: 64,
                  width: 280,
                  background: PANEL_BG,
                ...
                className="rounded-[16px] overflow-hidden pointer-events-auto"
              >
